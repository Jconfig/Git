console.log('To get random quote from here in your website add "<script src="https://git.joydeb.xyz/random-quote.js"></script>" between head tag . And also add "<script>getQuote=();</script>" between body tag where you need to show it :)');
